...
write.csv(pbmc.markers, "C:/Users/empage/Documents/P0_genes_subgroups_edited.csv")
```
#P1 
```{r}
...
pbmc.markers %>%
    group_by(cluster) %>%
    slice_max(n = 2, order_by = avg_log2FC)
write.csv(pbmc.markers, "C:/Users/empage/Documents/P1_genes_subgroups.csv")
```
#P6
```{r}
...
pbmc.markers %>%
    group_by(cluster) %>%
    slice_max(n = 2, order_by = avg_log2FC)
write.csv(pbmc.markers, "C:/Users/empage/Documents/P6_genes_subgroups.csv")
```
...
pbmc.markers %>%
    group_by(cluster) %>%
    slice_max(n = 2, order_by = avg_log2FC)
write.csv(pbmc.markers, "C:/Users/empage/Documents/P7_genes_subgroups.csv")
```
...
```{r}
pbmc.combined <- RunUMAP(pbmc.combined, dims = 1:5)
DimPlot(pbmc.combined, reduction = "umap")
```
...
pbmc.markers %>%
    group_by(cluster) %>%
    slice_max(n = 2, order_by = avg_log2FC)
write.csv(pbmc.markers, "C:/Users/empage/Documents/CAOV3_genes_subgroups.csv")
```
