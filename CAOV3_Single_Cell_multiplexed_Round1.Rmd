...
matrix <- Matrix::readMM("C:/Users/empage/Downloads/matrix.mtx")
```


```{r}
pbmc.data <- Read10X(data.dir = "C:/Users/empage/Documents/per_sample_outs/p0/count", cell.column = 1)
...
```{r}
# Load the PBMC dataset
pbmc.data_1 <- Read10X(data.dir = "~/Documents/Mythreye_Lab/Mehri_Resha/Single_cell_mehri/run_count_P7")
# Initialize the Seurat object with the raw (non-normalized data).
