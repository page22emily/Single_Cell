...
pbmc.data <- Read10X(data.dir = "~/Documents/Mythreye_Lab/Mehri_Resha/Single_cell_mehri/run_count_P0")
...
DimPlot(pbmc2, reduction = "umap")
```
looking at this, this appears to me to be more accurate, and the markers do show that there is still a mitochondrial subset, which is also present EARLY in PCA analysis 
```{r}
...
write.csv(pbmc.markers, "~/Desktop/P0_genes_subgroups_exploration.csv")
```
...
write.csv(pbmc.markers, "~/Desktop/P0_genes_subgroups_exploration_6.csv")
```
